...
/*
* Capacitor class inherits from Element
*/
class Capacitor: public Element {
public:
	Capacitor(std::string name, std::string positiveNode, std::string negativeNode, double value, Group group=Group::NO_GROUP):
