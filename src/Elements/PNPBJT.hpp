...
/*
* PNP Transistor class inherits from Element
*/
class PNPBJT: public Element {
public:
	PNPBJT(std::string name, std::string collectorNode, std::string baseNode, std::string emitterNode, double value=NO_VALUE):
